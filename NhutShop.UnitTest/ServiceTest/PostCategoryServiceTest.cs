...
namespace NhutShop.UnitTest.ServiceTest
{
    [TestClass]
    public class PostCategoryServiceTest
    {
        ...
        public void Initialize()
        {
            ...
            {
                new PostCategory() {ID=1, Name="XE1", Status=true },
                new PostCategory() {ID=2, Name="XE2", Status=true },
                new PostCategory() {ID=3, Name="XE3", Status=true },
            };
        }
